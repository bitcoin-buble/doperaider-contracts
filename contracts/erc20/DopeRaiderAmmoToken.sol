...
// DopeRaiderAmmoToken
// ----------------------------------------------------------------------------
contract DopeRaiderAmmoToken is ERC20Interface,  Owned  , FixedSupplyToken {
    using SafeMath for uint;

    uint consumableIndex = 3;
