...
contract DistrictsCoreInterface {
  ...
  function updateCokeTotal(uint256 _narcoId,  uint16 _total) public;
...
// DopeRaiderCokeToken
// ----------------------------------------------------------------------------
contract DopeRaiderCokeToken is ERC20Interface,  Owned  , FixedSupplyToken {
    using SafeMath for uint;
   ...
   NarcosCoreInterface public narcoCore;
    ...
    function redeemToken(uint256 _narcoId , uint8 _quantity) public  {
        ...
        // update the narco with the coke
        districtsCore.updateCokeTotal( _narcoId,   _quantity);
        districtsCore.distributeRevenue.value(_quantity*tokenValue)(redeemDistrict,0,100); // distribute the revenue to districts pots
