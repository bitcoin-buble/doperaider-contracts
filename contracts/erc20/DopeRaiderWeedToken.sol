...
// DopeRaiderWeedToken
// ----------------------------------------------------------------------------
contract DopeRaiderWeedToken is ERC20Interface,  Owned  , FixedSupplyToken {
    using SafeMath for uint;
   ...
   NarcosCoreInterface public narcoCore;
    ...
    function redeemToken(uint256 _narcoId , uint8 _quantity) public  {
        ...
        // update the narco with the weed
        districtsCore.updateWeedTotal( _narcoId,   _quantity);
        districtsCore.distributeRevenue.value(_quantity*tokenValue)(redeemDistrict,100,0); // distribute the revenue to districts pots
